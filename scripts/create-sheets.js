...
// 列定義：コマあたり担当職員 + 子ども を最大7セット
// 療育担当 最大5名 ＋ 保護者対応 最大2名 ＝ 合計7名
// A:日付 B:曜日 C:コマ D:時間帯 E:タイプ
// F:職員① G:子ども①名前 H:子ども①出欠 I:子ども①コメント ... ×7
// 最後: 集団メモ + 備考
const HEADERS=[
  '日付','曜日','コマ','時間帯','タイプ',
...
// 列幅: 固定5列 ＋ 7セット×4列 ＋ 集団メモ＋備考
const COL_W=[8,5,5,14,8, 12,12,9,28, 12,12,9,28, 12,12,9,28, 12,12,9,28, 12,12,9,28, 16,12,9,28, 16,12,9,28, 30,20]
...
async function main(){
  ...
  console.log(`   列構造: 担当職員① + 子ども①（名前/出欠/コメント） × 7セット（療育5名＋保護者対応2名）`)
